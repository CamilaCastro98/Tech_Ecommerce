...
const Card: React.FC<IProduct> = ({id,name,image,description,price,stock,categoryId}) => {
  ...
  <div className="m-3 shrink-0 rounded-md shadow-2xl">
    <div className="bg-gray-50 flex justify-center rounded-t-md w-auto h-[150px] md:h-[200px]">
        <Image loader={myLoader} className="p-4 rounded-t-lg w-auto h-[150px] md:h-[200px]" src={image} alt="product image" width={500} height={300} priority unoptimized  />
    </div>
